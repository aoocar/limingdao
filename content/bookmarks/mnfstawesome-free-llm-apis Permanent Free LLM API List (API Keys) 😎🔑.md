...
tags:
---
[![Awesome Free LLM APIs](https://github.com/mnfst/awesome-free-llm-apis/raw/main/media/awesome-free-llm-apis.png)](https://github.com/mnfst/awesome-free-llm-apis/blob/main/media/awesome-free-llm-apis.png)  
...
- [Groq](https://console.groq.com/keys) 🇺🇸 - Llama 3.3 70B, Llama 4 Scout, Kimi K2 +17 more. 30 RPM, 1K RPD (14,400 for Llama 3.1 8B). [^2]
...
- [Ollama Cloud](https://ollama.com/settings/keys) 🇺🇸 - DeepSeek-V3.2, Qwen3.5, Kimi-K2.5 +17 more. 1 concurrent model, light usage. [^3]
...
[^2]: 14,400 RPD only applies to Llama 3.1 8B Instant. Most other models (Llama 3.3 70B, Llama 4 Scout, Kimi K2, etc.) are limited to 1,000 RPD ([rate limits](https://console.groq.com/docs/rate-limits)).
